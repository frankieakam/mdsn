...
//               {/* 1. Incomplete Puzzle (Top Left) - More Spaced */}
//               <div className="absolute left-8 top-8 transform">
//                 <div className="bg-gradient-t-br from-gray-100 to-gray-200 rounded-2xl p-4 shadow-lg border border-dashed border-red-600">
...
//               {/* 3. Complete Puzzle (Bottom Center) - More Spaced */}
//               <div className="absolute left-1/2 bottom-[-9] transform -translate-x-1/2">
//                 <div className="bg-linear-to-br from-green-50 to-emerald-100 rounded-2xl p-4 shadow-lg border border-green-200">
//                   <div className="grid grid-cols-2 gap-[-15]">
//                     {/* Complete Puzzle Pieces */}
//                     <div className="w-10 h-10 bg-white rounded-tl-lg flex items-center justify-center shadow-sm border border-green-200">
//                       <Paintbrush className="w-4 h-4 text-green-600" />
//                     </div>
//                     <div className="w-10 h-10 bg-white rounded-tr-lg flex items-center justify-center shadow-sm border border-green-200">
//                       <Code className="w-4 h-4 text-green-600" />
//                     </div>
//                     <div className="w-10 h-10 bg-white rounded-bl-lg flex items-center justify-center shadow-sm border border-green-200">
//                       <Megaphone className="w-4 h-4 text-green-600" />
//                     </div>
//                     <div className="w-10 h-10 bg-white rounded-br-lg flex items-center justify-center shadow-sm border border-green-200">
...
//                   </div>
//                   <span className="text-xs text-blue-500 font-medium text-center max-w-[120px]"> Happy Client 
//                   </span>
//                 </div>
//               </div>
...
//                 {/* Line 3: Complete Puzzle → Client (Curved from Bottom Center to Left Center) */}
//                 <path 
//                   d="M140,300 Q100,290 54,254"
//                   stroke="#3B82F6" 
//                   strokeWidth="1" 
//                   strokeDasharray="0 0"
//                   fill="none"
...
//             </div>
//             <div className="absolute -bottom-4 -left-4 bg-white rounded-full p-2 shadow-lg border border-black">
